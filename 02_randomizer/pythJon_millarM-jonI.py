...
#Make a list of the keys in KREWES
keys = list(KREWES)

#Choose a random team out of the list of keys
team = keys[random.randint(0,len(keys)-1)]

#Choose a random member out of the team that was chosen 
member = KREWES[team][random.randint(0, len(KREWES[team])-1)]
